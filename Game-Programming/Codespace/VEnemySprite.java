...
public class VEnemySprite extends Sprite
{
  // the venemy's x- and y- step values are STEP +/- STEP_OFFSET
  private static final int STEP = 12;
  private static final int STEP_OFFSET = 2;

  private static double DURATION = .8;  // secs
  ...
  public VEnemySprite(int w, int h, ImagesLoader imsLd, ClipsLoader cl,
          				CodespacePanel cp, ShipSprite s, int p, Projectile[] pr) 
  { 
    super( w/2, 0, w, h, imsLd, "venemy");  
